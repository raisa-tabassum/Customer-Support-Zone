...
const Footer = () => {
    return (
        <div className='bg-black'>
            <div className='max-w-[1200px] mx-auto text-[#A1A1AA] flex justify-between py-12'>
                <div className='w-1/4'>
                <h1 className='text-white text-2xl font-semibold mb-3'>CS — Ticket System</h1>
            ...
            <div>
                <p className='max-w-[1200px] mx-auto text-center p-4 text-[#A1A1AA] text-xl'>© 2025 CS — Ticket System. All rights reserved.</p>
            </div>
        </div>
    );
};
