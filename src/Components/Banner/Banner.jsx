...
const Banner = ({ inProgressCount, resolvedCount }) => {
  return (
    <div className="flex flex-col md:flex-row sm:items-center mt-5 pt-20 gap-6 my-20 max-w-[1200px] mx-auto">
      <div className="relative overflow-hidden p-20 np-20 w-[600px] h-[250px] rounded-lg font-light text-white text-2xl text-center bg-gradient-to-br from-[#632EE3] to-[#9F62F2] ">
        <img
          src={Vector1Img}
          className="absolute top-0 left-0 w-full h-full object-contain object-left-top"
          alt=""
        />
        <img
          src={Vector2Img}
        ...
        />
        <p>In-Progress</p>
        <p className="mt-4 text-6xl font-semibold">{inProgressCount}</p>
      </div>
      <div className="relative overflow-hidden p-20 w-[600px] h-[250px] rounded-lg font-light text-white text-2xl text-center bg-gradient-to-r from-[#54CF68] to-[#00827A] ">
        ...
        />
        <p>Resolved</p>
        <p className="mt-4 text-6xl font-semibold">{resolvedCount}</p>
      </div>
    </div>
  );
};
